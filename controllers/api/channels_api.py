...
@channels_bp.route("/deleted_tracks")
...
@channels_bp.route("/restore_track", methods=["POST"])
...
def api_get_trash_stats():
    ...
    try:
        ...
        from .shared import _format_file_size
...
@channels_bp.route("/clear_trash", methods=["POST"])
def api_clear_trash():
